          ...
          <div className="bg-black/20 backdrop-blur-sm rounded-xl overflow-hidden w-full mb-6">
            ...
            <div className="relative h-64 w-full">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                ...
                <p className="text-sm text-white/80">Cours du lundi à Lyon 6</p>
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="flex flex-col gap-4 w-full">
               <a
  href="mailto:garnierbd@gmail.com,nathalyio@hotmail.com?subject=Demande de cours d'essai&body=Bonjour,%0D%0A%0D%0AJ'aimerais réserver un cours d'essai avec Bernard le lundi ____/____/____. %0D%0A%0D%0AJe serais intéressé par :%0D%0A- Le premier cours (18h20 – 19h35) si il vous reste de la place%0D%0A- Le 2e cours (19h45 – 21h00) si il vous reste de la place%0D%0A%0D%0A(Merci de préciser votre préférence et d'indiquer vos informations personnelles : nom, prénom, âge, numéro de téléphone)%0D%0A%0D%0ACordialement"
          ...
          <div className="bg-black/25 backdrop-blur-sm rounded-2xl p-6 w-full mb-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white/5 rounded-xl p-4">
                  <h3 className="text-base font-semibold mb-2 text-white">Objectifs des cours</h3>
                  <ul className="space-y-1 text-xs">
